...
def get_code_from_image(image_path, user_prompt):
...
# Example usage
# image_path = "/home/dhruvi/Desktop/Pr_generation_bot/back-end/src/Screenshot from 2024-10-09 16-16-38.png"
# user_prompt = "Give me react js code of the image uploaded"
# response = get_code_from_image(image_path, user_prompt)
# print(response)
# file_name, file_extension = generate_FileName_and_extension(response)
